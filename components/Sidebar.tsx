...
interface SidebarProps {
  activeView: 'companies' | 'clients'
  onViewChange: (view: 'companies' | 'clients') => void
  activePage: 'sales' | 'finance' | 'contract' | 'team'
  onPageChange: (page: 'sales' | 'finance' | 'contract' | 'team') => void
}

export default function Sidebar({ activeView, onViewChange, activePage, onPageChange }: SidebarProps) {
  return (
    <div 
      ...
      >
        <div className="flex flex-col items-center" style={{ width: '42px', height: '220px', gap: '12px' }}>
          ...
          <div 
            ...
            style={{ width: '28px', height: '46px', gap: '2px', cursor: 'pointer' }}
          ...
          >
            ...
            <span
              style={{
                ...
                color: activePage === 'sales' ? '#FFFFFF' : 'rgba(255, 255, 255, 0.8)'
              }}
            >
              Sales
            </span>
          ...
          <div 
            className="flex flex-col items-start" 
            style={{ width: '37px', height: '46px', gap: '2px', cursor: 'pointer' }}
          ...
          >
            <div
              ...
              style={{
                ...
                padding: '3.5px 7px',
                gap: '4.67px',
                background: activePage === 'finance' ? '#FFFFFF' : 'transparent',
                borderRadius: '9.33333px'
              }}
            >
              <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M14.3 9.09334V9.76001C14.3 9.94001 14.16 10.0867 13.9733 10.0933H13C12.6467 10.0933 12.3267 9.83334 12.3 9.48668C12.28 9.28001 12.36 9.08668 12.4933 8.95334C12.6133 8.82668 12.78 8.76001 12.96 8.76001H13.9667C14.16 8.76668 14.3 8.91334 14.3 9.09334Z" fill={activePage === 'finance' ? '#0C2D25' : 'rgba(255, 255, 255, 0.8)'}/>
                <path d="M11.9933 8.46005C11.66 8.78672 11.5 9.27338 11.6333 9.78005C11.8067 10.4001 12.4133 10.7934 13.0533 10.7934H13.6333C14 10.7934 14.3 11.0934 14.3 11.4601V11.5867C14.3 12.9667 13.1733 14.0934 11.7933 14.0934H4.14C2.76 14.0934 1.63333 12.9667 1.63333 11.5867V7.10005C1.63333 6.28005 2.02667 5.55338 2.63333 5.10005C3.05333 4.78005 3.57333 4.59338 4.14 4.59338H11.7933C13.1733 4.59338 14.3 5.72005 14.3 7.10005V7.39338C14.3 7.76005 14 8.06005 13.6333 8.06005H12.9533C12.58 8.06005 12.24 8.20672 11.9933 8.46005Z" fill={activePage === 'finance' ? '#0C2D25' : 'rgba(255, 255, 255, 0.8)'}/>
                <path d="M10.8 3.21337C10.98 3.39337 10.8267 3.67337 10.5733 3.67337L5.45333 3.66671C5.16 3.66671 5.00667 3.30671 5.22 3.10004L6.3 2.01337C7.21333 1.10671 8.69333 1.10671 9.60667 2.01337L10.7733 3.19337C10.78 3.20004 10.7933 3.20671 10.8 3.21337Z" fill={activePage === 'finance' ? '#0C2D25' : 'rgba(255, 255, 255, 0.8)'}/>
              </svg>
            </div>
            <span
              style={{
                ...
                textAlign: 'center',
                letterSpacing: '0.005em',
                color: activePage === 'finance' ? '#FFFFFF' : 'rgba(255, 255, 255, 0.8)'
              }}
            >
              Finance
            </span>
          ...
          <div 
            className="flex flex-col items-start" 
            style={{ width: '42px', height: '46px', gap: '2px', cursor: 'pointer' }}
          ...
          >
            ...
            <span
              style={{
                ...
                textAlign: 'center',
                letterSpacing: '0.005em',
                color: activePage === 'contract' ? '#FFFFFF' : 'rgba(255, 255, 255, 0.8)'
              }}
            >
              Contract
            </span>
          ...
          >
            ...
            <span
              style={{
                ...
                textAlign: 'center',
                letterSpacing: '0.005em',
                color: activePage === 'team' ? '#FFFFFF' : 'rgba(255, 255, 255, 0.8)'
              }}
            >
              Team
            </span>
        ...
        <div className="flex flex-col items-start" style={{ width: '187px', height: '78px', gap: '8px' }}>
          <div className="flex flex-col items-start" style={{ width: '187px', height: '16px', gap: '8px' }}>
            <div className="flex flex-row justify-center items-center" style={{ width: '187px', height: '16px', gap: '44px' }}>
              ...
              >
                {activePage === 'sales' ? 'Sales' : activePage === 'finance' ? 'Finance' : activePage === 'contract' ? 'Contract' : 'Team'}
              </span>
            </div>
          </div>
          {activePage === 'sales' && (
                ...
                <div className="flex flex-row justify-center items-center" style={{ width: activeView === 'companies' ? '171px' : 'auto', height: '16px', gap: '6px' }}>
                  ...
                  <span
                    style={{
                      ...
                      lineHeight: '16px',
                      letterSpacing: '0.005em',
                      color: activeView === 'companies' ? '#FFFFFF' : '#999999'
                    }}
                  >
                    Companies
                  </span>
            ...
            <div className="flex flex-col items-start" style={{ width: '187px', height: '25px', gap: '8px' }}>
              <div
                ...
                style={{
                  ...
                  padding: '5px 8px',
                  gap: '10px',
                  background: activeView === 'clients' ? '#2B2B2B' : 'transparent',
                  borderRadius: '6px',
                  cursor: 'pointer'
                }}
              >
                <div className="flex flex-row justify-center items-center" style={{ width: activeView === 'clients' ? '171px' : 'auto', height: '16px', gap: '6px' }}>
                  <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M7 1.16663C5.47166 1.16663 4.22916 2.40913 4.22916 3.93746C4.22916 5.43663 5.40166 6.64996 6.93 6.70246C6.97666 6.69663 7.02333 6.69663 7.05833 6.70246C7.07 6.70246 7.07583 6.70246 7.0875 6.70246C7.09333 6.70246 7.09333 6.70246 7.09916 6.70246C8.5925 6.64996 9.765 5.43663 9.77083 3.93746C9.77083 2.40913 8.52833 1.16663 7 1.16663Z" fill={activeView === 'clients' ? '#FFFFFF' : '#999999'}/>
                    <path d="M9.96333 8.25418C8.33583 7.16918 5.68167 7.16918 4.0425 8.25418C3.30167 8.75001 2.89333 9.42085 2.89333 10.1383C2.89333 10.8558 3.30167 11.5208 4.03667 12.0108C4.85333 12.5592 5.92667 12.8333 7 12.8333C8.07333 12.8333 9.14667 12.5592 9.96333 12.0108C10.6983 11.515 11.1067 10.85 11.1067 10.1267C11.1008 9.40918 10.6983 8.74418 9.96333 8.25418Z" fill={activeView === 'clients' ? '#FFFFFF' : '#999999'}/>
                  </svg>
                  <span
                    style={{
                      width: '99px',
                      ...
                      lineHeight: '16px',
                      letterSpacing: '0.005em',
                      color: activeView === 'clients' ? '#FFFFFF' : '#999999'
                    }}
                  >
                    Clients
                  </span>
          ...
          {activePage !== 'sales' && (
            <div className="flex flex-col items-start" style={{ width: '187px', height: '54px', gap: '4px' }}>
              <div className="flex flex-col items-center justify-center" style={{ width: '187px', height: '54px', color: '#999999', fontFamily: 'SF Pro', fontSize: '12px' }}>
