...
export default function SortableRow({ 
  ...
  const isMenuOpen = openStateMenu === company.id || openActionMenu === company.id
          ...
          {openActionMenu === company.id && (
            ...
            >
              <input
                ...
                onFocus={(e) => {
                  e.target.style.border = '1px solid #009679'
                  e.target.style.boxShadow = '0px 0px 2px rgba(54, 186, 122, 0.5)'
                }}
                onBlur={(e) => {
                  e.target.style.border = '1px solid #2B2B2B'
